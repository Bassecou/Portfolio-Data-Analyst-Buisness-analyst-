...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Bassecou_Toure-0077B5?style=flat&logo=linkedin)](https://www.linkedin.com/in/bassecou-toure)
...
### 📊 [Dashboard de pilotage PMO — Power BI](https://github.com/Bassecou/P7-dashboard-pmo-powerbi)
...
### 🏠 [Analyse prédictive immobilière — Python / ML](https://github.com/Bassecou/P8-analyse-predictive-immobilier)
...
### 📈 [Dashboard performances BI — Power BI / ETL](https://github.com/Bassecou/P9-dashboard-performances-bi)
...
### 🛒 [Optimisation & nettoyage des données — Python](https://github.com/Bassecou/P6-nettoyage-donnees-stock)
`Python` `Pandas` `NumPy` `Power Query` `RGPD`
> BottleNeck · Rapprochement ERP + e-commerce · Analyse 20/80 · Corrélation commerciale

---

### 🎮 [Analyse business & segmentation de marché](https://github.com/Bassecou/P10-analyse-business-segmentation)
...
### 🦷 [Analyse de satisfaction client — SQL](https://github.com/Bassecou/P5-satisfaction-client-sql)
`SQL` `PostgreSQL` `NPS` `Analyse métier`
> BestMarket · RetailInsight360 · Requêtes complexes · 3 axes d'amélioration stratégiques

---

### 🔐 [Conformité RGPD & anonymisation — SQL](https://github.com/Bassecou/P4-rgpd-anonymisation)
`SQL` `SQLite` `Power Query` `RGPD`
> Courtier assurance auto · Sanction CNIL · Anonymisation · Documentation technique

---

### 🗄️ [Conception de base de données — SQL](https://github.com/Bassecou/P3-conception-bdd-sql)
